...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        make_debet: function () {
            if (Number(x.balance) - Number(this.oper_balance) < 0) this.error = prompt("Error!", "Wrong ammount of money!");
        ...
        make_operation: function () {
            ...
            if (x = this.contracts.find(x => x.contract_num === this.contract_num_form)) {
                if (x.contract_num.indexOf("26251") === 0) {
                    if (Number(x.balance) - Number(this.oper_balance) < 0 && this.oper_type == "Снятие") this.error = prompt("Error!", "Wrong ammount of money!");else {
                    ...
                    if (Number(x.balance) - Number(this.oper_balance) < -50000 && this.oper_type == "Снятие") this.error = prompt("Error!", "Credit limit is over!");else {
                        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('http://localhost:8080/api/operation/', {
                            operation: {
                                card_lim: -50000,
                                contract_num: this.contract_num_form,
                    ...
                    if (Number(x.balance) - Number(this.oper_balance) <= -150000 && this.oper_type == "Снятие") this.error = prompt("Error!", "Credit limit is over!");
                    if (Number(x.balance) + Number(this.oper_balance) > 0 && this.oper_type == "Депозит") this.error = prompt("Error!", "More money than your credit!");else {
                        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('http://localhost:8080/api/operation/', {
                            operation: {
                                card_lim: -150000,
                                contract_num: this.contract_num_form,
    ...
    created: function () {
        ...
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('http://localhost:8080/api/operations/').then(function (response) {
            console.log(response);
            self.operations = response.data;
        }).catch(function (error) {
            console.log(error);
        });
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('http://localhost:8080/api/comission/').then(function (response) {
            console.log(response);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('input', {
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.oper_balance = $event.target.value
      }
    }
  }), _vm._v(" "), _c('br'), _vm._v(" "), _c('p', [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.oper_type),
      expression: "oper_type"
    }],
    attrs: {
      "size": "1"
    },
    on: {
      "change": function($event) {
        ...
        _vm.oper_type = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    attrs: {
  ...
  }, [_vm._v("Снятие")]), _vm._v(" "), _c('option', {
    attrs: {
      "value": "Депозит"
    }
  }, [_vm._v("Депозит")])])]), _vm._v(" "), _c('button', {
    on: {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.contract_num_form_cancel),
    ...
    on: {
      "click": function($event) {
        _vm.cancel_operation()
      }
    }
  }, [_vm._v("Cancel")]), _vm._v(" "), _c('h3', [_vm._v("Contract table")]), _vm._v(" "), _c('ul', _vm._l((_vm.contracts), function(item) {
    return _c('li', [_vm._v("\n                Number of contract:\n                " + _vm._s(item.contract_num) + "\n                "), _c('br'), _vm._v("\n                Balance:\n                " + _vm._s(item.balance) + "\n            ")])
  })), _vm._v(" "), _c('h3', [_vm._v(" Comission of bank is: " + _vm._s(_vm.comission)), _c('br'), _vm._v("(Bank num:26250111111111111)"), _c('br'), _vm._v(" weewquewiqy343ui12y43iughewriueyoqbewrioe ")]), _vm._v(" "), _c('br'), _vm._v(" "), _c('h3', [_vm._v("Operations table")]), _vm._v(" "), _c('ul', _vm._l((_vm.operations), function(item) {
    return _c('li', [_vm._v("\n            Number of contract:\n            " + _vm._s(item.contract_num) + "\n            "), _c('br'), _vm._v("\n            Sum of operation:\n            " + _vm._s(item.sum) + "\n            "), _c('br'), _vm._v("\n            Type of operation:\n            " + _vm._s(item.oper_type) + "\n            "), _c('br'), _vm._v("\n            Date:\n            " + _vm._s(item.date) + "\n        ")])
  }))])
},staticRenderFns: []}
